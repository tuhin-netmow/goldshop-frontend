    ...
    },
    {
      ...
      cell: ({ row }) => (
        <div className="text-right font-medium">
          {row.original.total_sales ? Number(row.original.total_sales).toFixed(2) : "0.00"}
        </div>
      ),
    },
    {
      ...
      cell: ({ row }) => (
        <div className="text-right font-medium text-green-600">
          {row.original.paid_amount ? Number(row.original.paid_amount).toFixed(2) : "0.00"}
        </div>
      ),
    },
    {
      ...
      cell: ({ row }) => (
        <div className="text-right font-bold text-orange-600">
          {row.original.due_amount ? Number(row.original.due_amount).toFixed(2) : "0.00"}
        </div>
      ),
    },
    {
