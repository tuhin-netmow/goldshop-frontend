        ...
        <div className="flex gap-2">
          {payment.invoice && (
            <Link to={`/dashboard/sales/invoices/${payment.invoice.id}`}>
              <Button variant="outline" className="gap-2 shadow-sm text-blue-600 hover:text-blue-700">
                <FileText className="w-4 h-4" /> View Invoice
              </Button>
            </Link>
          )}
          <Link to={`/dashboard/sales/payments/${paymentData.id}/receipt`}>
            <Button variant="outline" className="gap-2 shadow-sm text-emerald-600 hover:text-emerald-700">
